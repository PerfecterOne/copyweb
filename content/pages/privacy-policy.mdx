...
description: Privacy policy for CopyWeb
created_at: 2026-01-15
---

## Introduction

Welcome to CopyWeb, the **ultimate free website code generator** designed to help you replicate any website design with text prompts, screenshots, Figma files or URL. At CopyWeb, your privacy is of utmost importance to us, and this privacy policy outlines how we collect, use, and protect your personal information when you use our services.

## Information Collection and Use

We collect the following types of data to provide you with a better experience while using CopyWeb:
...
2. **Usage Details**
   - **What We Collect**: Information about how you use CopyWeb, including your interactions, features accessed, and usage frequency.
   - **Purpose**: To analyze user engagement and improve our services.

3. **Device Information**
   - **What We Collect**: Data regarding the devices you use to access CopyWeb, such as device type, operating system, and browser type.
...
5. **Uploaded Content**
   - **What We Collect**: Screenshots, URLs, Figma files, or text prompts you provide for code generation.
   - **Purpose**: To process your requests and generate the corresponding code. We do not store this content permanently.
...
**Copyright Owner**: [copyweb.net](https://copyweb.net)
**Email**: [support@copyweb.net](mailto:support@copyweb.net)

By using CopyWeb, you consent to our privacy policy and agree to its terms. Thank you for trusting us with your information!
