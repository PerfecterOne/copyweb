...
export async function getSettings() {
  const settings: Setting[] = [
    ...
    {
      name: 'credits_per_1k_input_tokens',
      title: 'Credits per 1K Input Tokens',
      type: 'number',
      placeholder: '1',
      value: '1',
      group: 'credit',
      tab: 'general',
      tip: 'Number of credits to deduct per 1,000 input tokens',
    },
    {
      name: 'credits_per_1k_output_tokens',
      title: 'Credits per 1K Output Tokens',
      type: 'number',
      placeholder: '5',
      value: '5',
      group: 'credit',
      tab: 'general',
      tip: 'Number of credits to deduct per 1,000 output tokens (typically 5x input cost)',
    },
    {
